...
| Japanese version of the same animation (HTML with JavaScript, about 28 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/one-step-animation-ja.html](slides/one-step-animation-ja.html) · [slides/one-step-animation-ja-narration.mp3](slides/one-step-animation-ja-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/ja/one-step/) |
| English animated explainer of the word-labelled method (Sections 4 and 5.3; HTML with JavaScript, about 24 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/word-label-animation-en.html](slides/word-label-animation-en.html) · [slides/word-label-animation-en-narration.mp3](slides/word-label-animation-en-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/en/word-label/) |
| Japanese version of the same animation (HTML with JavaScript, about 29 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/word-label-animation-ja.html](slides/word-label-animation-ja.html) · [slides/word-label-animation-ja-narration.mp3](slides/word-label-animation-ja-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/ja/word-label/) |
| English animated explainer of the waiting-time theorem, the reach and limits of the method, and the further results and open problems (Sections 6–8, 10 and 11 and Appendices B–E; HTML with JavaScript, about 26 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/frontier-animation-en.html](slides/frontier-animation-en.html) · [slides/frontier-animation-en-narration.mp3](slides/frontier-animation-en-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/en/frontier/) |
