...
| English animated explainer of the one-step method (Sections 3 and 5.1; HTML with JavaScript, about 20 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/one-step-animation-en.html](slides/one-step-animation-en.html) · [slides/one-step-animation-en-narration.mp3](slides/one-step-animation-en-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/en/one-step/) |
| Japanese version of the same animation (HTML with JavaScript, about 25 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/one-step-animation-ja.html](slides/one-step-animation-ja.html) · [slides/one-step-animation-ja-narration.mp3](slides/one-step-animation-ja-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/ja/one-step/) |
| English animated explainer of the word-labelled method (Sections 4 and 5.3; HTML with JavaScript, about 23 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/word-label-animation-en.html](slides/word-label-animation-en.html) · [slides/word-label-animation-en-narration.mp3](slides/word-label-animation-en-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/en/word-label/) |
| Japanese version of the same animation (HTML with JavaScript, about 28 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/word-label-animation-ja.html](slides/word-label-animation-ja.html) · [slides/word-label-animation-ja-narration.mp3](slides/word-label-animation-ja-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/ja/word-label/) |
| English animated explainer of the waiting-time theorem, the reach and limits of the method, and the further results and open problems (Sections 6–8, 10 and 11 and Appendices B–E; HTML with JavaScript, about 25 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/frontier-animation-en.html](slides/frontier-animation-en.html) · [slides/frontier-animation-en-narration.mp3](slides/frontier-animation-en-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/en/frontier/) |
| Japanese version of the same animation (HTML with JavaScript, about 32 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/frontier-animation-ja.html](slides/frontier-animation-ja.html) · [slides/frontier-animation-ja-narration.mp3](slides/frontier-animation-ja-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/ja/frontier/) |
| English animated explainer of the verification and the Lean formalization (Section 9 and Appendix A; HTML with JavaScript, about 15 minutes; open in a web browser) and its narration (MP3, Gemini 3.8 Flash TTS; keep it next to the HTML) | [slides/verification-animation-en.html](slides/verification-animation-en.html) · [slides/verification-animation-en-narration.mp3](slides/verification-animation-en-narration.mp3) · [watch online](https://ixixi.github.io/rational-floor-certificates/en/verification/) |
...
| 1ステップ法（第3節・第5.1節）の英語の解説アニメーション（JavaScript を使う HTML、約20分。ブラウザで開く）とナレーション音声（MP3。Gemini 3.8 Flash TTS で作成。HTML と同じフォルダに置く） | [slides/one-step-animation-en.html](slides/one-step-animation-en.html) · [slides/one-step-animation-en-narration.mp3](slides/one-step-animation-en-narration.mp3) · [オンラインで見る](https://ixixi.github.io/rational-floor-certificates/en/one-step/) |
| 同じアニメーションの日本語版（JavaScript を使う HTML、約25分。ブラウザで開く）とナレーション音声（MP3。Gemini 3.8 Flash TTS で作成。HTML と同じフォルダに置く） | [slides/one-step-animation-ja.html](slides/one-step-animation-ja.html) · [slides/one-step-animation-ja-narration.mp3](slides/one-step-animation-ja-narration.mp3) · [オンラインで見る](https://ixixi.github.io/rational-floor-certificates/ja/one-step/) |
| 語ラベル法（第4節・第5.3節）の英語の解説アニメーション（JavaScript を使う HTML、約23分。ブラウザで開く）とナレーション音声（MP3。Gemini 3.8 Flash TTS で作成。HTML と同じフォルダに置く） | [slides/word-label-animation-en.html](slides/word-label-animation-en.html) · [slides/word-label-animation-en-narration.mp3](slides/word-label-animation-en-narration.mp3) · [オンラインで見る](https://ixixi.github.io/rational-floor-certificates/en/word-label/) |
| 同じアニメーションの日本語版（JavaScript を使う HTML、約28分。ブラウザで開く）とナレーション音声（MP3。Gemini 3.8 Flash TTS で作成。HTML と同じフォルダに置く） | [slides/word-label-animation-ja.html](slides/word-label-animation-ja.html) · [slides/word-label-animation-ja-narration.mp3](slides/word-label-animation-ja-narration.mp3) · [オンラインで見る](https://ixixi.github.io/rational-floor-certificates/ja/word-label/) |
| 待ち時間の定理、方法の届く範囲と限界、追加の結果と未解決問題（第6〜8節・第10〜11節・付録B〜E）の英語の解説アニメーション（JavaScript を使う HTML、約25分。ブラウザで開く）とナレーション音声（MP3。Gemini 3.8 Flash TTS で作成。HTML と同じフォルダに置く） | [slides/frontier-animation-en.html](slides/frontier-animation-en.html) · [slides/frontier-animation-en-narration.mp3](slides/frontier-animation-en-narration.mp3) · [オンラインで見る](https://ixixi.github.io/rational-floor-certificates/en/frontier/) |
| 同じアニメーションの日本語版（JavaScript を使う HTML、約32分。ブラウザで開く）とナレーション音声（MP3。Gemini 3.8 Flash TTS で作成。HTML と同じフォルダに置く） | [slides/frontier-animation-ja.html](slides/frontier-animation-ja.html) · [slides/frontier-animation-ja-narration.mp3](slides/frontier-animation-ja-narration.mp3) · [オンラインで見る](https://ixixi.github.io/rational-floor-certificates/ja/frontier/) |
| 検証と Lean による形式化（第9節・付録A）の英語の解説アニメーション（JavaScript を使う HTML、約15分。ブラウザで開く）とナレーション音声（MP3。Gemini 3.8 Flash TTS で作成。HTML と同じフォルダに置く） | [slides/verification-animation-en.html](slides/verification-animation-en.html) · [slides/verification-animation-en-narration.mp3](slides/verification-animation-en-narration.mp3) · [オンラインで見る](https://ixixi.github.io/rational-floor-certificates/en/verification/) |
