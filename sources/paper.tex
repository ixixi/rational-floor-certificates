...
\input{figures/illustrations/style.tex}
...
\hyperref[ref-s26]{S26, §4}, which reports finite graph certificates, eventual
...
to be excluded.
For comparison, \hyperref[ref-dj22]{DJ22, Theorem 1.2, p.167} implies that for the
...
\begin{figure}[htbp]
\centering
\input{figures/illustrations/certificate-flow.tex}
...
\begin{figure}[htbp]
\centering
\input{figures/illustrations/cell-intersection.tex}
...
\begin{figure}[htbp]
\centering
\input{figures/illustrations/cell-refinement.tex}
...
\begin{figure}[htbp]
\centering
\input{figures/illustrations/phase-test.tex}
...
\begin{figure}[htbp]
\centering
\input{figures/illustrations/word-contraction.tex}
...
\begin{figure}[htbp]
\centering
\input{figures/illustrations/prime-lift.tex}
...
\begin{figure}[htbp]
\centering
\input{figures/illustrations/initial-graph.tex}
...
\begin{figure}[htbp]
\centering
\input{figures/illustrations/stage-counts.tex}
...
\begin{figure}[htbp]
\centering
\input{figures/illustrations/rank-certificate.tex}
